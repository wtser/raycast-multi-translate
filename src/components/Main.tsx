...
export function Main(): ReactElement {
  ...
  return (
    ...
    >
      {correctedText ? (
        <SpellcheckItem text={sourceText} corrected={correctedText} />
      ) : null}
              ...
              <ActionPanel>
                <ActionPanel.Section>
                  ...
                  <Action.OpenInBrowser
                    ...
                    url={`https://translate.google.com/?sl=${item.from}&tl=${
                      item.to
                    }&text=${encodeURIComponent(item.original)}&op=translate`}
                  />
                  <Action.OpenInBrowser
                    title="Open in Google Search"
                    url={`https://google.com/?q=${encodeURIComponent(
                      item.original
                    )}`}
                  />
                  <Action
